...
class Query(BaseModel):
    ...
    jc: List[str] = Field(None, description='職種')
    # [Literal["飲食/フード", "販売", "接客/サービス", "レジャー/エンタメ", "営業", "事務", "総務/企画", "教育", "物流/配送", "軽作業", "建築/土木/建設", "工場/製造", "IT/コンピュータ", "医療/介護/福祉", "マスコミ/出版", "芸能", "ガールズバー/キャバクラ/パブ/クラブ", "専門職/その他"]
    jmc: List[str] = Field(None, description='職種細分類')
        #Literal[
